...
class Clock(Tk):
    def __init__(self):
        ...
        self.date_label = Label(self.clock_frame, text="05/25/2024", font=(font, self.small_text))
        ...
        self.feels_like_temp_label = Label(self.weather_frame, text="25", font=(font, int(self.small_text / 2)))
        ...
        self.temp_low_label = Label(self.high_low_frame, text="20", font=(font, self.small_text))
        ...
        self.temp_high_label = Label(self.high_low_frame, text="25", font=(font, self.small_text))
        ...
        self.humidity_label = Label(self.humidity_frame, text="15", font=(font, self.small_text))
        ...
        self.uv_label = Label(self.uv_frame, text="15", font=(font, self.small_text))
